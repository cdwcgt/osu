...
namespace osu.Game.Tests.Visual.Gameplay
{
    public partial class TestSceneStoryboardWithOutro : PlayerTestScene
    {
        ...
        private event Func<JudgementResult, bool> currentFailConditions;
        ...
        public override void SetUpSteps()
        {
            ...
            AddStep("reset fail conditions", () => currentFailConditions = (_) => false);
        ...
        public void TestOutroEndsDuringFailAnimation()
        {
            CreateTest(() =>
            {
                AddStep("fail on first judgement", () => currentFailConditions = (_) => true);
        ...
        protected partial class OutroPlayer : TestPlayer
        {
            ...
            private event Func<JudgementResult, bool> failConditions;

            public OutroPlayer(Func<JudgementResult, bool> failConditions, bool showResults = true)
            ...
            protected override void LoadComplete()
            {
                ...
                {
                    if (failConditions.Invoke(result))
                    {
