...
{
    public partial class IrcChannelListingItem : OsuClickableContainer, IHasContextMenu
    {
        ...
        {
            new OsuMenuItem("Leave Channel", MenuItemType.Destructive, () => bancho.PartChannelAsync(Channel.ChannelName))
        };
    }
}
